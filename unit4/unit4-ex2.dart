import 'dart:io';
//จงเขียนโปรแกรม มีความต้องการดังนี้ ต้องการรับข้อมูลยอดซื้อของลูกค้า 20 คน
//และต้องการนับจำนวนว่าคนที่ซื้อสินค้ายอดขายเกิน 1 ล้านบาทกี่คน ต่ำกว่า 1 ล้านบาท แต่มากกว่าหรือเท่ากับ 3 แสนบาทกี่คน 
//และน้อยกว่า 3 แสนบาทกี่คน และ หายอดรวมของลูกค้าแต่ละกลุ่ม
...
void show(List<int> n) {
  ...
  for (int i = 0; i < n.length; i++) {
    ...
    } else if (n[i] >= 300000 && n[i] < 1000000) {
      //กลุ่มน้อยกว่า1000000 และ มากกว่า300000
  ...
  stdout.write(
      'จำนวนผู้ที่มียอดซื้อน้อยกว่า 1ล้านบาทและมียอดซื้อเกิน 3แสนบาท มีจำนวน $c2 คน');
